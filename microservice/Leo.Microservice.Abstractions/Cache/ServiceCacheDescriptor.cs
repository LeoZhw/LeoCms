...
namespace Leo.Microservice.Abstractions.Cache
{
    ...
    {/// <summary>
     ...
     /// </summary>
        ...
        {
            var model = obj as ServiceCacheDescriptor;
            if (model == null)
                return false;
        ...
        public static bool operator ==(ServiceCacheDescriptor model1, ServiceCacheDescriptor model2)
        {
